...
export const metadata: Metadata = {
  ...
  description: "Portfolio mewah Rafly Baehaqi. Membangun aplikasi web responsif dengan ritme kode yang presisi, dipadukan dengan soul musik blues & rock.",
  keywords: ["Next.js", "React", "Supabase", "Web Developer", "Gitaris", "Portfolio", "Yogyakarta"],
...
export default function RootLayout({
  ...
  return (
    <html lang="id" suppressHydrationWarning className={`${plusJakartaSans.variable} ${inter.variable} ${jetbrainsMono.variable}`}>
