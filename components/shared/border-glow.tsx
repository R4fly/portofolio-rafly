...
/**
 * BorderGlow — Card dengan directional glow yang follow cursor.
 * Accessibility: respects prefers-reduced-motion (disables animated sweep).
 */
export default function BorderGlow({
  ...
  coneSpread = 25,
  animated = false,
  colors = ['#22d3ee', '#f59e0b', '#a855f7'], // cyan, amber, purple (matches brand)
  fillOpacity = 0.5,
}: BorderGlowProps) {
  ...
  useEffect(() => {
    ...
    if (!animated || !cardRef.current || reduceMotion) return
