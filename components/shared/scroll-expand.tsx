...
/**
 * ScrollExpand — Scroll-triggered expanding frame component.
 *
 * Accessibility: respects `prefers-reduced-motion` by disabling smoothing
 * (frame locks to scrollbar position without animation).
 */
export default function ScrollExpand({
  ...
  const applyProgress = useCallback((p: number): void => {
