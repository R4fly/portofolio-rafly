...
/**
 * SpecularButton — Premium CTA dengan WebGL specular highlight.
 *
 * Accessibility:
 * - Respects prefers-reduced-motion (disables animation, keeps static glow)
 * - Graceful fallback jika WebGL tidak tersedia (renders plain button)
...
export default function SpecularButton({
  ...
  useEffect(() => {
    ...
    // Reduced motion: skip WebGL entirely, render plain button
    ...
    if (!hasWebGL2 || reduceMotion) return
