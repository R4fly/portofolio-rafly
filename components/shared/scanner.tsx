...
const ctxMap = new WeakMap<HTMLDivElement, ScannerContext>()
...
/**
 * Scanner — WebGL CRT scan effect.
 *
 * Accessibility:
 * - Reduced motion: disables animation, shows static field
 * - Visibility: pauses rendering when off-screen
 * - Page visibility: pauses when tab not active
 */
export default function Scanner({
  ...
  useEffect(() => {
    ...
    // For reduced motion: render once with frozen time, no loop
    if (reduceMotion) {
  ...
  useEffect(() => {
    ...
    const uColor1 = u.uColor1.value as Float32Array
    const uColor2 = u.uColor2.value as Float32Array
    const uColor3 = u.uColor3.value as Float32Array
    uColor1[0] = c1[0]; uColor1[1] = c1[1]; uColor1[2] = c1[2]
    uColor2[0] = c2[0]; uColor2[1] = c2[1]; uColor2[2] = c2[2]
    uColor3[0] = c3[0]; uColor3[1] = c3[1]; uColor3[2] = c3[2]
